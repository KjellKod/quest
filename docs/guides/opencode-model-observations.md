...
14. **Codex respects permission boundaries, KiMi doesn't** — When edit was denied, Codex reported being blocked and output content as text. KiMi bypassed via `cat >` bash. Permission discipline varies by model.
