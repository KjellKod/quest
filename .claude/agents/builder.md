...
4. If the brief's router classification has `ui_work: true`, also read `.skills/ux-context/SKILL.md` and its bundled resources so the code honors UX principles
